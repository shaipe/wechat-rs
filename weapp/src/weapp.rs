...
use std::io::Cursor;
use crate::{WeChatResult,Client};
use crate::{aes256_cbc_decrypt,aes128_cbc_decrypt};
...
impl WeApp
{
    ...
    ///获取session_key
    pub async fn get_session_key(&self,appid:&str,code:&str,component_appid:&str,component_access_token:&str)-> WeChatResult<serde_json::Value>{
    ...
    ///获取手机号
    pub  fn get_phone_num(&self,session_key:&str,iv:&str,encrypte_data:&str)->WeChatResult<String>{
...
#[cfg(test)]
mod tests {
    use super::{WeApp,aes128_cbc_decrypt,aes256_cbc_decrypt};
